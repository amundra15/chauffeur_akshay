...
class configMain:
	...
	def __init__(self):
		...
		self.number_steering_bins = 3		#divide steering angles into 3 bins

		self.batch_size=self.number_steering_bins*40
		self.batch_size_val =  self.number_steering_bins*40
...
class configTrain(configMain):
	...
	def __init__(self):
		...
		self.learning_rate = 0.0001 # First
