...
class configMain:
	...
	def __init__(self):
		...
		self.variable_names = ['Steer','Gas','Brake','Hand_B','Reverse','Steer_N','Gas_N','Brake_N','Pos_X','Pos_Y','Pos_Z','Speed',\
						'Yaw','Yaw_S','Col','Res','Goal_x','Goal_y','Control','Distance','Noise','Time_Stamp']
...
class configInput(configMain):
	...
	def __init__(self):
		...
		path = '/home/fcodevil/Datasets/gtabatchtest'
...
class configTrain(configMain):
	...
	def __init__(self):
		...
		self.learning_rate = 0.0 #0.0002 # First
		...
		self.network_name = 'vist_test'#'controlNetSpeedP_deeper'	
