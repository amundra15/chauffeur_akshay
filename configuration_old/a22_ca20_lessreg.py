...
class configMain:
	...
	def __init__(self):
		...
		self.dropout = [1.]*8 + [0.7]*2 + [0.7]*2 + [0.7]*1 + [0.7, 1.]*7
...
class configInput(configMain):
	...
	def __init__(self):
		...
		self.augment = iaa.Sequential([
	        ...
	        st(iaa.Multiply((0.5, 2.), per_channel=0.2)), # change brightness of images (X-Y% of original value)
...
class configTrain(configMain):
	...
	def __init__(self):
		...
		self.network_name = 'controlNetSpeedP_deeper'	
