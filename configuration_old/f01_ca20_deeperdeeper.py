...
class configMain:
	...
	def __init__(self):
		...
		# 8 conv layers, 2 img FC layer, 3 speed FC layers, 2 joint FC layer, 7 branches X 3 FC layers each
		self.dropout = [0.8]*8 + [0.5]*2 + [0.5]*3 + [0.5]*2 + [0.5,0.5, 1.]*7
...
class configInput(configMain):
	...
	def __init__(self):
		...
		path = '/home/adosovit/work/data/CARLA/CarlaBatch7Clean'
...
class configTrain(configMain):
	...
	def __init__(self):
		...
		self.network_name = 'controlNetSpeedP_deeper_deeper'	
