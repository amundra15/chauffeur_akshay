...
class configMain:
	...
	def __init__(self):
		...
		self.variable_names = ['Steer','Gas','Brake','Hand_B','Reverse','Steer_N','Gas_N','Brake_N','Pos_X','Pos_Y','Pos_Z','Speed',\
						'Yaw','Yaw_S','Col','Lane','Res','Goal_x','Goal_y','Control','Distance','Noise','Time_Stamp']
		...
		self.number_iterations = 500000 # 300k
...
class configInput(configMain):
	...
	def __init__(self):
		...
		path = '/home/fcodevil/Datasets/GTA/gtabatchtest'
		...
		self.labels_per_division = [[0,2,5,1],[3,6],[4,7,8]] 
...
class configTrain(configMain):
	...
	def __init__(self):
		...
		self.loss_function = 'mse_branched_boostpedals'  # Chose between: mse_branched, mse_branched_ladd
		...
		self.output_weigth = [0.45,0.45,0.45,0.45,0.05,0.5,0.05]
		self.network_name = 'controlNetSpeedP_deeper_vis'#'controlNetSpeedP_deeper'	
