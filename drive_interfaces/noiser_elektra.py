...
class Noiser(object):
	#the only change in this file is Control class has speed, steer instead of those 5 variables for carla
	...
	#intensity = 5, min_noise_time_amount =0.5, float(random.randint(50,150) 
	#intensity = 15,min_noise_time_amount =0.0)
	#intensity = 8

	# STRONG GTA NOISE 
	# intensity = 8,min_noise_time_amount =0.5
